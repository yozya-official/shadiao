...
declare global {
  ...
  const durationOptions: typeof import('./stores/options')['durationOptions']
  ...
  const useBackgroundOptions: typeof import('@/stores/options')['useBackgroundOptions']
  ...
  const useStyleOptions: typeof import('@/stores/options')['useStyleOptions']
  ...
  const useVideoStore: typeof import('./stores/videoStore')['useVideoStore']
  ...
  const useWorldOptions: typeof import('@/stores/options')['useWorldOptions']
  const videoApi: typeof import('./api/index')['videoApi']
  const viewsOptions: typeof import('./stores/options')['viewsOptions']
