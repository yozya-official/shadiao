<template>
  <div class="min-h-screen bg-background">
    <!-- 头部装饰背景 -->
    <div
      class="absolute top-0 left-0 w-full h-48 bg-gradient-to-r from-primary/20 via-chart-2/20 to-chart-3/20"
    ></div>
    ...
    <div class="container mx-auto p-6 max-w-4xl relative">
      ...
      >
        ...
        >
          ...
          <div class="relative">
            <div
              class="w-28 h-28 rounded-2xl bg-gradient-to-br from-primary/80 to-chart-2/80 p-1 shadow-lg"
            >
              <img
                :src="author.avatar"
            ...
            <!-- 装饰元素 -->
            <div
              class="absolute -top-2 -right-2 w-6 h-6 bg-chart-4 rounded-full border-3 border-card shadow-md"
            ></div>
          </div>
