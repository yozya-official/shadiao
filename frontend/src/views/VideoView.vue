  ...
  <div class="min-h-screen bg-background">
    ...
    <div class="container mx-auto px-6 py-8 max-w-7xl relative">
      ...
      <div class="text-center mb-8">
        <div
          class="hidden md:inline-flex items-center justify-center size-16 rounded-2xl bg-gradient-to-br from-primary to-chart-2 text-primary-foreground mb-4 shadow-lg hover:scale-105 transition-transform duration-300"
        >
        ...
        <div>
          <h2
            class="mb-2 font-bold bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent"
          >
            沙雕动画收集站
          </h2>
          <p class="text-muted-foreground max-w-2xl text-sm mx-auto">
            发现更多精彩作品，探索无限创意世界
          </p>
        </div>
      ...
      <div v-if="sortedVideos.length" class="relative">
        ...
        <div class="absolute inset-0 pointer-events-none">
          ...
          <div
            class="absolute bottom-20 right-20 w-40 h-40 bg-chart-2/5 rounded-full blur-3xl"
          ></div>
        </div>
      </div>
