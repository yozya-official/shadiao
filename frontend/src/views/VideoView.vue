<template>
  <PageActionHeader title="沙雕动画收集站" subtitle="发现更多精彩作品，探索无限创意世界">
    <template #icon>
      <svg class="size-8" fill="white" viewBox="0 0 20 20">
        <path
          d="M2 6a2 2 0 012-2h6a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z"></path>
      </svg>
    </template>
  </PageActionHeader>
  <div class="container px-6 py-8 relative">
    ...
    <div v-if="filteredVideos.length" class="relative">
      <VideoContainer
        ...
        :show-author="true"
        ref="videoContainerRef"></VideoContainer>

      <PageNavigator
        class="mt-8 md:mt-12 mx-auto"
        :total="filteredVideos.length"
        v-model:current-page="currentPage"
        :page-size="pageSize"></PageNavigator>
    </div>
...
import { PageActionHeader, PageNavigator } from '@yuelioi/ui'
