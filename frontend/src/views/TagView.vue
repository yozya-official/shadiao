<template>
  <!-- 页面标题 -->
  <PageActionHeader title="标签" subtitle="浏览标签">
    <template #icon>
      <svg class="w-8 h-8" fill="white" viewBox="0 0 20 20">
        <path
          d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zm2 3h6v2H7V6zm0 4h6v2H7v-2zm0 4h6v2H7v-2z"></path>
      </svg>
    </template>
  </PageActionHeader>
    ...
    <div class="card p-6">
      ...
      <div class="relative">
        ...
        <div class="absolute inset-0 pointer-events-none">
          ...
          <div
            class="absolute bottom-10 right-10 w-32 h-32 bg-chart-2/5 rounded-full blur-2xl"></div>
        </div>
