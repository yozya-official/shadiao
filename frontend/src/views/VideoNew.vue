<template>
  <!-- 页面标题 -->
  <PageActionHeader title="添加精彩作品" subtitle="记录和分享你发现的优秀沙雕动画">
    <template #icon>
      <svg class="w-12 h-12" fill="white" viewBox="0 0 20 20">
        <path
          d="M8 12a4 4 0 1 1 8 0 4 4 0 0 1-8 0zM2 5a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5zM6 5a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1zM6 9a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1zM6 13a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1z"></path>
      </svg>
    </template>
  </PageActionHeader>
        ...
        <div
          ...
          <div class="flex items-center justify-between mb-6">
            <div class="flex items-center">
              <div
                class="w-4 h-4 bg-gradient-to-br from-primary to-chart-2 rounded-full mr-4"></div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div
              ...
              <!-- 渐变遮罩 -->
              <div
                class="absolute inset-0 bg-gradient-to-t from-background/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="space-y-4">
                <label class="flex items-center space-x-2 font-semibold">
                  ...
                  <span>背景设定</span>
                  <span class="text-sm font-normal">(架空背景也算)</span>
                </label>
                <select
